    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="rounded-2xl bg-white p-6 md:p-8 shadow-lg">
          <h2 className="text-center text-2xl font-semibold text-slate-900">Complete Your Profile</h2>
          <p className="mt-1 text-center text-sm text-slate-600">Welcome, {user?.displayName}! Just a few more details to get you started.</p>
